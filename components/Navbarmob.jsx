...
export default function Navbarmob() {
  ...
  const navbaritems = [
    {
      id: 1,
      src: "/ds-img/chatx.png",
      alt: "Chat",
      ulname: `${t.navbar.n1}`,
      href: "/astrologer/chat",
    },
    {
      id: 2,
      src: "/ds-img/telephonex.png",
      alt: "Talk",
      ulname: `${t.navbar.n2}`,
      href: "/astrologer/call",
    },
    {
      id: 3,
  ...
  const dhwaniStoreItems = [
    {
      ...
      href: "https://shop.dhwaniastro.com/collections/bracelets",
    },
    {
      id: 2,
      name: `${t.navbar.n8}`,
    ...
    },
    {
      ...
      href: "https://shop.dhwaniastro.com/collections/crystal-rings",
    },
    {
      id: 4,
      name: `${t.navbar.n10}`,
      src: "/ds-img/compass.png",
      href: "https://shop.dhwaniastro.com/collections/vastu-1",
    },
    {
      id: 5,
      name: `${t.navbar.n11}`,
          ...
          <ul className="flex flex-col items-start  space-y-5">
            {navbaritems.map((navit) => (
              <li key={navit.id} className="w-full">
                <Link
                  href={navit.href}
                  className="flex items-center space-x-3 text-lg text-[#2f1254] hover:text-[#8334e4]"
                  onClick={() => setIsOpen(false)}
                >
                  <Image
                    priority
            ...
            <li className="w-full">
              <button
                aria-label="Toggle Dhwani Store Menu"
        ...
        <ul className="flex items-center justify-evenly">
          {navbaritems.map((navit) => (
            <li key={navit.id} className="desk-nav-li hover:scale-108">
              <Link
                href={navit.href}
                className="flex flex-col head-wrap items-center gap-1"
              >
                <Image
                  ...
                  alt={navit.alt}
                />
                <h3 className="head-spn text-black text-xs sm:text-[10px] lg:text-[12px]">
                  {navit.ulname}
                </h3>
              </Link>
            </li>
          ...
          <li className="drop-free-new desk-nav-li">
            <Link
              href="#"
              className="flex flex-col items-center gap-1 head-wrap "
            >
              <Image
                className="img-head-nav sm:w-6 sm:h-6 md:w-7 md:h-7 lg:w-9 lg:h-9"
                src="/prblm/store.png"
            ...
            <ul className="free-service-drop-n">
              <li>
                ...
                >
                  <Image
                    ...
                    priority
                  />
                  <h3 className="free-ser-spn text-black text-xs">
                    {" "}
                    {t.navbar.n7}
                  </h3>
                </Link>
              ...
              <li>
                <Link
                  href="https://shop.dhwaniastro.com/"
                  target="_"
