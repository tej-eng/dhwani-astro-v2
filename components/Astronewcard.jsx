  ...
  return (
    <section className="flex-col items-center self-center w-full sm:max-w-7xl">
      <div className="flex flex-col items-center justify-center rounded-full px-4 sm:py-4 py-0 sm:max-w-7xl">
        <h1 dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize(t?.consult?.heading || "Consult with our Top Premium Astrologers") }} className=" text-[#2f1254] text-[15px] sm:text-xl lg:text-2xl  py-3 text-center font-semibold">
        </h1>
        <div className="setup-wrap w-full">
          <div className="relative rounded-xl md:rounded-full z-10 grid items-start justify-center w-full grid-cols-4 gap-1 py-2 mt-3 shadow-lg user-sign-up sm:grid-cols-4 lg:grid-cols-4 sm:gap-6">
            <div className="flex flex-col items-center justify-center gap-2 p-1 text-center service-card-sign rounded-xl sm:p-3">
              ...
              <p dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize(t?.consult?.tag1 || "Sign Up with Dhwani Astro" )}} className="text-[9px] sm:text-xs text-[#2f1254] sm:font-semibold">
              </p>
            </div>
            ...
            <div className="flex flex-col items-center justify-center gap-2 p-1 text-center service-card-sign rounded-xl sm:p-3">
              ...
              <p dangerouslySetInnerHTML={{ __html:DOMPurify.sanitize( t?.consult?.tag2 || "Put Money in Dhwani Astro Wallet") }} className="text-[9px] sm:text-xs text-[#2f1254] sm:font-semibold">
              </p>
            </div>
            ...
            <div className="flex text-black text flex-col items-center justify-center gap-2 p-1 text-center service-card-sign rounded-xl sm:p-3">
              ...
              <p dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize(t?.consult?.tag3 || "Click on Call or Chat") }} className="text-[9px] sm:text-xs text-[#2f1254] sm:font-semibold">
              </p>
            </div>
            ...
            <div className="flex flex-col items-center justify-center gap-2 p-1 text-center service-card-sign rounded-xl sm:p-3">
              ...
              <p dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize(t?.consult?.tag4 || "Rate & Review after consultation") }} className="text-[9px] sm:text-xs text-[#2f1254] sm:font-semibold">
              </p>
            </div>
          </div>
        </div>
