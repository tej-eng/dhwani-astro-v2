                        ...
                        <div className="flex flex-col md:flex-row items-center gap-5">
                            ...
                            <div className="flex flex-col gap-2 text-black text-sm items-start">
                                <span className='flex flex-col md:flex-row justify-between items-center w-full'>
                                    <h5 className="text-sm md:text-base font-semibold">Legal Case Consultation</h5>
                                ...
                                <p className='text-start'> We understand the importance of privacy when dealing with legal matters.
                                    Our platform ensures that all your consultations are confidential and secure, giving you peace of mind as you discuss your legal concerns.</p>
                            </div>
                        </div>
                        <button aria-label="Continue to Legal Consultation"
                        ...
                        <div className="flex flex-col gap-4">
                            <div className="consult-page relative flex flex-col md:flex-row w-full md:h-screen md:overflow-hidden">
                                ...
                                <div className="md:w-1/2 w-full md:h-screen overflow-y-scroll p-4 md:p-6 right-det">
                                    <h1 className="md:text-2xl text-xl font-bold text-gray-800 mb-2">Legal Case Consultation</h1>
                                    ...
                                    <div className="text-gray-700 md:mb-6 mb-3 text-xs md:text-sm bg-yellow-50 px-3 py-2 rounded-lg shadow-lg">
                                        <strong>Legal consultations are crucial for understanding your rights and obligations under the law. </strong>
                                        <p>Don’t let legal issues overwhelm you. Consult best Lawyers at our convenience and take the first step towards
                                            resolving your legal matters efficiently and effectively.</p>
                                    </div>

                                    <div className="mb-4 flex flex-col md:flex-row items-center justify-between">
                                        <label className="block text-sm md:text-base text-gray-700 font-semibold mb-2">Select Your Required Consultation :</label>
                                    ...
                                    <div className="bg-yellow-50 py-4 px-4 rounded-lg text-gray-800 md:space-y-4 space-y-2">
                                        ...
                                        <ul className="list-disc list-inside space-y-2 text-xs md:text-sm">
                                            <li>Get expert advice on property disputes, title verification, lease agreements, and real estate transactions.</li>
                                            <li> Receive guidance on criminal cases, FIR registration, bail applications, and court proceedings.</li>
                                            <li>Seek advice on civil disputes, consumer rights, recovery of dues, and other civil matters</li>
                                        </ul>
                                    </div>
                            ...
                            <div className="max-w-5xl mx-auto px-4 py-10 text-gray-800 text-sm">
                                <h1 className="text-xl font-semibold mb-4">
                                    Astrology is often believed by some to provide insights into various aspects of life, including <span className="font-bold">legal matters and issues</span>.
                                </h1>
                                <p className="mb-4 text-gray-700">
                                    While astrology is not a substitute for legal advice or professional expertise, some individuals turn to astrological insights for guidance or additional perspectives. Here are some legal problems where astrology is sometimes considered to offer insights.
                                </p>
                                <ul className="space-y-4 list-disc list-inside">
                                    <li>
                                        <span className="font-bold">Court Cases:</span> People seeking astrological insights for court cases may consult astrologers to analyze the positions of planets at the time of trial. They believe that planetary influences might affect the overall environment of the courtroom and the possible outcome of the case.
                                    </li>
                                    <li>
                                        <span className="font-bold">Legal Disputes:</span> When individuals face legal conflicts, they may consult astrologers to gain insights into potential outcomes. Astrology enthusiasts believe that planetary positions at the time of the dispute could provide information about the underlying dynamics and possible resolutions.
                                    </li>
                                    <li>
                                        <span className="font-bold">Property Disputes:</span> Astrology could be consulted for insights into property-related legal conflicts. For instance, individuals might inquire about auspicious times for negotiations, settlements, or even property transactions that could help resolve disputes.
                                    </li>
                                    <li>
                                        <span className="font-bold">Criminal Cases:</span> Some people turn to astrology to understand criminal cases. They may seek guidance on how planetary influences could impact the investigation, trial, and possible sentencing, offering a unique perspective.
                                    </li>
                                    <li>
                                        <span className="font-bold">Divorce Proceedings:</span> Individuals undergoing divorce might consult astrologers for insights into the timing and potential outcomes of divorce proceedings. They may inquire about auspicious times to initiate the legal process and anticipate potential settlements.
                                    </li>
                                    <li>
                                        <span className="font-bold">Child Custody Battles:</span> Parents involved in child custody battles might seek astrological insights for guidance. They may inquire about favorable times to present their case, helping them anticipate possible outcomes related to custody arrangements.
                                    </li>
                                    <li>
                                        <span className="font-bold">Contractual Issues:</span> People dealing with contractual disputes might consult astrologers for insights into the validity of agreements. They may inquire about favorable times for negotiations, signing contracts, or even settling disputes.
                                    </li>
                                    <li>
                                        <span className="font-bold">Business Partnerships:</span> Astrology could be used to assess the compatibility between business partners and anticipate potential conflicts. Entrepreneurs might seek insights into how planetary influences might affect their collaborative ventures.
                                    </li>
                                    <li>
                                        <span className="font-bold">Employment Disputes:</span> Individuals facing employment-related legal conflicts might inquire about astrological insights. They could seek guidance on the potential resolution of workplace disputes and the likelihood of success.
                                    </li>
                                </ul>
                            </div>
                        </div>
