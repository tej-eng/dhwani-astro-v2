...
export default function Marriageconsult() {
  ...
  return (
    <div className="relative w-full">
            ...
            <div className="flex flex-col md:flex-row items-center gap-5">
              ...
              <div className="flex flex-col gap-2 text-black text-sm items-start">
                ...
                <p className="text-start">
                  Get personalized guidance on your marriage and relationships
                  through Vedic astrology. Understand compatibility, resolve
                  conflicts, and find clarity for a harmonious partnership.
                </p>
              </div>
            </div>
            <button aria-label="Continue to Marriage Consultation"
      ...
      <div
        className={`bg-yellow-50 min-h-screen flex items-start justify-center  p-4 md:p-6w-full ${showPopup ? "blur-sm pointer-events-none" : ""
          }`}
      >
              ...
              <div className="consult-page relative flex flex-col md:flex-row w-full md:h-screen md:overflow-hidden">
                ...
                <div className="md:w-1/2 w-full md:h-screen overflow-y-scroll p-4 md:p-6 right-det">
                  ...
                  <div className="text-gray-700 md:mb-6 mb-3 text-xs md:text-sm bg-yellow-50 px-3 py-2 rounded-lg shadow-lg">
                    <strong>
                      Marriage counseling plays a crucial role in improving
                      relationship quality by tackling issues like communication
                      breakdowns, trust issues, and couple conflicts.
                    </strong>
                    <p>
                      Utilizing proven techniques and astrological tailored
                      methods, they assist couples in understanding each other's
                      viewpoints, building empathy, and reconnecting. Whether
                      addressing specific problems or seeking to enhance your
                      relationship, consulting a marriage counselor can be a
                      pivotal step toward a more joyful and satisfying
                      partnership.
                    </p>
                  </div>
                  ...
                  <div className="bg-yellow-50 shadow-lg py-4 px-4 rounded-lg text-gray-800 space-y-2">
                    <h2 className="text-sm md:text-base font-semibold flex items-center gap-2">
                      Why Marriage Counselling is Essential :
                    </h2>
                    <ul className="list-disc list-inside space-y-2 text-xs md:text-sm">
                      <li> Enhanced Communicatio</li>
                      <li>Strengthening Emotional Bonds</li>
                      <li>
                        Rebuilding trust after infidelity is challenging but
                        possible with professional help.
                      </li>
                      <li>
                      ...
                      <li>
                        When emotional disconnection occurs, counselling can
                        help rebuild intimacy and understanding.
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="bg-yellow-50 shadow-lg py-4 px-4 rounded-lg text-gray-800 md:space-y-4 space-y-2">
                    ...
                    <ul className="list-disc list-inside space-y-2 text-xs md:text-sm">
                      <li>
                        A detailed analysis done by me of your horoscope
                        oriented towards your marriage/relationship prospects,
                      </li>
                      <li>
                        A detailed report (i.e. your complete Kundali/horoscope)
                        containing all your charts, dashas and other basic
                        details.
                      </li>
                      <li>
                        Compatibility insights with your current or potential
                        partner
                      </li>
                      <li>
                        Predictions regarding timing of marriage or relationship
                        developments
                      </li>
                      <li>
                        Remedies and guidance to improve harmony and resolve
                        conflicts
                      </li>
                    </ul>
                  </div>
              ...
              <div className="max-w-5xl mx-auto px-4 py-10 text-gray-800 text-sm">
                ...
                <ul className="space-y-2 list-disc list-inside">
                  ...
                  <li>
                    ...
                    Astrology can reveal planetary influences behind separation
                    and guide you through emotional healing. Get clarity on
                    karmic patterns and future relationship prospects.
                  </li>
                  <li>
                    <span className="font-bold">Affairs & Betrayals :</span>
                    Understand the astrological triggers of infidelity and
                    betrayal. Discover the deeper lessons and planetary reasons
                    influencing trust issues in your chart.
                  </li>
                  <li>
                    <span className="font-bold">Infidelity :</span>
                    Analyze the alignment of Venus, Mars, and the 7th house to
                    explore tendencies toward infidelity. Receive remedies and
                    advice to restore trust and commitment.
                  </li>
                  <li>
                    <span className="font-bold">Compatibility issues :</span>
                    Astrology can assess the compatibility between two
                    individuals based on their birth charts. It can help
                    identify potential challenges and areas of harmony, offering
                    guidance on building a stronger foundation for the
                    relationship.
                  </li>
                  <li>
                    <span className="font-bold">Behavioural Issues :</span>
                    Discover how planetary positions affect temperament and
                    behavior in relationships. Get remedies to manage
                    impulsiveness, mood swings, or emotional imbalance.
                  </li>
                  <li>
                    <span className="font-bold">Parenting : </span>
                    Understand your parenting style and compatibility with your
                    child through your birth chart. Astrology offers guidance
                    for nurturing a healthier parent-child bond.
                  </li>
                  <li>
                    <span className="font-bold">Anger Management :</span>
                    Mars and other fiery influences can cause anger or
                    irritability. Learn to channel these energies constructively
                    and practice remedies for inner calm.
                  </li>
                  <li>
                    <span className="font-bold">Emotional Disturbance :</span>
                    Identify planetary causes behind emotional turbulence. Get
                    support through astrological counseling and recommended
                  ...
                  <li>
                    ...
                    Astrology can offer insights into the sexual and sensual
                    preferences of individuals, helping couples understand each
                    other’s desires and preferences. It can guide partners in
                    fostering a fulfilling and intimate connection.
                  </li>
                  <li>
                    <span className="font-bold">Peer Relationships :</span>
                    Analyze the 11th house and other placements to understand
                    your social life. Astrology can help you improve
                    communication and foster more meaningful friendships.
                  </li>
                </ul>
              </div>
            </div>
