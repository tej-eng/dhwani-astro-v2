        ...
        <div className="relative w-full">
                        ...
                        <div className="flex flex-col md:flex-row items-center gap-5">
                            ...
                            <div className="flex flex-col gap-2 text-black text-sm items-start">
                                <span className='flex flex-col md:flex-row justify-between items-start w-full'>
                                    <h5 className="text-sm md:text-base font-semibold">Business Consultation</h5>
                                ...
                                <p className='text-start'> A strong Business Management System guided by astrological insights can serve as the backbone of a successful organization.
                                    Many businesses struggle to scale due to the absence of structured strategies aligned with favorable planetary periods and a lack
                                    of accountability mechanisms rooted in astrological timing and compatibility.</p>
                            </div>
                        </div>
                        <button aria-label="Continue to Business Consultation"
            ...
            <div className={`bg-yellow-50 min-h-screen flex items-start justify-center  p-4 md:p-6 w-full ${showPopup ? 'blur-sm pointer-events-none' : ''}`}>
                <div className="bg-white shadow-lg rounded-lg flex flex-col w-full max-w-6xl overflow-hidden">
                    ...
                    {showConsultPage && (
                        <div className="flex flex-col gap-4 conslut-main">
                            <div className="consult-page relative flex flex-col md:flex-row w-full md:h-screen md:overflow-hidden">
                                ...
                                <div className="md:w-1/2 w-full md:h-screen overflow-y-scroll p-4 md:p-6 right-det">
                                    <h1 className="md:text-2xl text-xl font-bold text-gray-800 mb-2">Business Consultation</h1>
                                    ...
                                    <div className="text-gray-700 md:mb-6 mb-3 text-xs md:text-sm bg-yellow-50 px-3 py-2 rounded-lg shadow-lg">
                                        <strong>For small and medium businesses (SMEs), growth is more than just increasing revenue—it
                                            requires structured management, strategic decision-making, and scalable processes. </strong>
                                        <p>Many businesses struggle to scale due to the absence of structured strategies aligned with favorable planetary
                                            periods and a lack of accountability mechanisms rooted in astrological timing and compatibility.</p>
                                    </div>


                                    <div className="mb-4 flex flex-col md:flex-row items-center justify-between">
                                        <label className="block text-gray-700 text-sm md:text-base font-semibold mb-2">Select Your Required Consultation :</label>
                                        <select className="w-full text-xs md:text-sm text-black border border-gray-300 rounded-lg p-1" value={selectedMuhurta}
                                            ...
                                            <option> New Business Launch Consultation</option>
                                            <option>Business Partnership Compatibility</option>
                                            <option> Auspicious Dates for Business Activities</option>
                                            <option>Financial Growth & Risk Analysis</option>
                                            <option> Location & Office Setup Consultation</option>
                                    ...
                                    <div className="bg-yellow-50 py-4 px-4 rounded-lg text-gray-800 md:space-y-4 space-y-2">
                                        ...
                                        <ul className="list-disc text-xs md:text-sm list-inside space-y-2 ">
                                            <li>Astrological Business Compatibility Report</li>
                                            <li>Auspicious Timing for Key Decisions.</li>
                                            <li>Risk Assessment Based on Planetary Periods</li>
                                            <li>Personalized astrological remedies and practical advice to enhance decision-making and remove business obstacles.</li>
                                        </ul>
                                    </div>
                                    <div className="bg-yellow-50 shadow-lg py-4 px-4 rounded-lg text-gray-800 space-y-2">
                                        <h2 className="md:text-base text-sm font-semibold flex items-center gap-2">

                                            Why you need Buisness astrology consultation:
                                        </h2>
                                        <ul className="list-disc list-inside space-y-2 text-xs md:text-sm">
                                            <li> Business Feels Stuck & Directionless</li>
                                            <li>Unstructured Processes & Inconsistent Operations</li>
                                            <li>Struggling Leadership & Decision-Making</li>
                                            <li>To Optimized business processes that lead to greater consistency and scalability.</li>
                                            <li> Ineffective Business Planning & Execution </li>
                                        </ul>
                                    </div>
                            ...
                            <div className="p-4 bg-white text-black text-sm w-[90%] place-self-center shadow-lg ">
                                <h2 className="md:text-2xl text-base font-semibold mb-2">Service Details</h2>
                            ...
                            <div className="max-w-5xl mx-auto px-4 py-10 text-gray-800 text-sm">
                                <h1 className="text-xl font-semibold mb-4">
                                    Astrology is often believed by some to provide insights into various aspects of life, including business growth, decision-making, and leadership strategy.                                </h1>
                                <p className="mb-4 text-gray-700">
                                    While astrology is not a substitute for business acumen or professional consulting, many entrepreneurs and business leaders turn to astrological insights to support their strategic planning, risk assessment, and timing of key decisions. Here are some business-related challenges where astrology is often consulted for additional guidance:                                </p>
                                <ul className="space-y-4 list-disc list-inside">
                                    <li>
                                        <span className="font-bold">New Business Ventures:</span> Entrepreneurs may consult astrologers to determine the most auspicious time to launch a new business. Planetary alignments are believed to influence the success, momentum, and long-term sustainability of a startup.
                                    </li>
                                    <li>
                                        <span className="font-bold">Partnership Compatibility:</span>Before entering into business partnerships, individuals often seek astrological compatibility analysis to evaluate alignment in working styles, financial goals, and mutual trust—helping to prevent future conflicts.
                                    </li>
                                    <li>
                                        <span className="font-bold">Business Expansion & Investment:</span> Business owners may look for favorable planetary periods before investing in expansion, opening new branches, or entering new markets. Astrological insights are used to assess financial risks and growth opportunities.
                                    </li>
                                    <li>
                                        <span className="font-bold">Financia l Challenges & Recovery:</span> During periods of financial downturn or instability, astrology can be consulted to understand planetary causes behind challenges and to suggest corrective timing and remedies for recovery.
                                    </li>
                                    <li>
                                        <span className="font-bold">Property & Office Setup Decisions:</span> Choosing the right location or direction for offices and business operations is sometimes guided by astrology and Vastu. This is believed to influence prosperity, employee harmony, and overall energy flow.
                                    </li>
                                    <li>
                                        <span className="font-bold">Leadership & Role Assignment:</span> Astrology may be used to assess the leadership qualities of founders or key personnel and guide decisions regarding role allocation and team restructuring for better alignment and productivity.
                                    </li>
                                    <li>
                                        <span className="font-bold">Client & Market Timing:</span> Astrological timing (Muhurta) is often used to determine favorable days for product launches, marketing campaigns, contract signings, and other critical business milestones.
                                    </li>
                                    <li>
                                        <span className="font-bold">Crisis Management and Recovery Strategy:</span> In the case of internal or external disputes, astrological advice may help in choosing the right time for negotiations or mediations, potentially leading to smoother resolutions.
                                    </li>
                                </ul>
                            </div>
                        </div>
