    ...
    <div className="head-wrap call-chat-nw w-full rounded-lg p-3 flex flex-col gap-5 py-5 my-3">
      ...
      <div className="flex items-center justify-center gap-5">
          ...
          <CustomButton
            ...
            type="button"
            variant={"red"}
            className=" flex items-center gap-4 rounded-full bg-green-500 px-4 py-2 hover:scale-104 "
          >
          ...
          <CustomButton 
            ...
            type="button"
            variant={"red"}
            className="flex items-center gap-4 rounded-full bg-rose-500 hover:scale-104 px-4 py-2 "
          >
            <svg
              width={20}
              height={20}
