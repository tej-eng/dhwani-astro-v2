...
export default function Personal() {
  ...
  return (
    <div className=" call-chat-nw head-wrap w-full rounded-lg p-3 flex flex-col gap-3 py-5">
      <div className="cc-top-con">
        <h3 className=" text-center text-red-400 text-base md:text-xl ">
          Get Personalized Horoscope & Predictions 2025
        </h3>
      </div>
      <div className="text-black text-xs md:text-sm">We all are curious to know our personalized
        horoscope or future in order to calculate the favorable and unfavorable times of our life.
        Chirag Daruwalla is the best way to find answers to the mystery called the year 2024. Our team will
        give you a glimpse of your life in the year 2024.</div>
      <div className="flex items-center justify-center gap-5">
        <Link href={"/homepage/talkto"}>    <CustomButton aria-label="Email Now" variant={"red"} type="button" className="neumorphism cursor-pointer
     flex items-center gap-2 px-7 md:px-10 md:py-3 py-2 rounded-full border border-rose-600 text-rose-600 hover:scale-105">
          <svg fill="#000000" width={20} height={20} viewBox="0 0 512 512"  ><title>mail</title><path d="M64 128Q64 113 73 105 81 96 96 96L416 96Q431 96 440 105 448 113 448 128L448 144 256 272 64 144 64 128ZM256 328L448 200 448 384Q448 416 416 416L96 416Q64 416 64 384L64 200 256 328Z" /></svg>
          <span className="text-xs text-rose-600">Email Now</span>
        </CustomButton></Link>

        <Link href={"/homepage/navbarcomp"}>
          <CustomButton aria-label="Call Now" variant={"red"} type="button" className="neumorphism cursor-pointer 
   flex items-center gap-2 px-7 md:px-10 md:py-3 py-2 rounded-full border border-rose-600 text-rose-600 hover:scale-105">
