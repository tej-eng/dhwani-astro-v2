...
const KundliMilan = () => {
    ...
    useEffect(() => {
        ...
        fetchData();
    }, [matchData, triggerMatch, triggerMatchObs, triggerMatchAstro, triggerManglik, triggerMatchReport]);
            ...
            <div className="w-full max-w-4xl mx-auto mt-4 flex flex-col gap-10">
                <div className="det-div w-full bg-white p-6 rounded-lg shadow-xl">
                    <div className="flex justify-center gap-10 mb-4">
                        <Image src="/ds-img/newmatchboy.png" alt="boy" width={50} height={50} />
                        <Image src="/ds-img/Couple.png" alt="couple" width={50} height={10} />
                        <Image src="/ds-img/newmatchgrl.png" alt="girl" width={50} height={50} />
                    </div>
                    ...
                    <div className="grid grid-cols-1 text-black md:grid-cols-2 gap-6 text-sm">
                        <div className="bg-purple-200 p-4 rounded-lg flex flex-col gap-1">
                            <p><strong>Name:</strong> {matchData?.boyData?.name}</p>
                            <p><strong>Birth Date:</strong> {matchData?.boyData?.dob}</p>
                            <p><strong>Birth Time:</strong> {matchData?.boyData?.birthTime}</p>
                            <p><strong>Birth Place:</strong> {matchData?.boyData?.birthplace || matchData?.boyData?.birthPlace || '-'}</p>
                        </div>
                        <div className="bg-pink-200 p-4 rounded-lg flex flex-col gap-1">
                            <p><strong>Name:</strong> {matchData?.girlData?.name}</p>
                            <p><strong>Birth Date:</strong> {matchData?.girlData?.dob}</p>
                            <p><strong>Birth Time:</strong> {matchData?.girlData?.birthTime}</p>
                            <p><strong>Birth Place:</strong> {matchData?.girlData?.birthplace || matchData?.girlData?.birthPlace || '-'}</p>
                        </div>
                    </div>
